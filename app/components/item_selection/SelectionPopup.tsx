...
export const SelectionPopup = ({ token }: { token: PoolToken }) => {
  ...
  return (
    <TransparentDialogContent className="h-full  max-h-[1164px] grid-areas-nft-modal [grid-template-columns:repeat(4,20%)_1fr] [grid-template-rows:auto_auto_1fr_1fr_1fr] sm:max-w-8xl">
