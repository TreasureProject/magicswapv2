...
export default function Homepage() {
  return (
    <>
      <div className="h-auto bg-[url(/img/home/hero.png)] bg-bottom bg-cover bg-night-700 py-24 md:h-[548px] md:py-0">
        <div className="mx-auto flex h-full w-full max-w-[90%] flex-col items-center justify-center space-y-8 text-center md:max-w-lg">
          <div className="space-y-3">
            <motion.h1
              ...
              className="font-bold text-3xl text-cream md:text-4xl"
            >
              Magicswap Protocol
            </motion.h1>
            <motion.p
      ...
      >
        <div className="max-w-[90%] gap-6 space-y-6 md:max-w-md md:space-y-10">
          <div className="space-y-5 text-center md:text-left">
            <h1 className="font-semibold text-2xl text-cream md:text-4xl">
              Universal Token Compatibility
            </h1>
            <p className="text-silver-500 md:text-xl">
          ...
          <Link
            to={DOCS_URL}
            className="mx-auto flex items-center gap-1 text-silver-500 transition-colors hover:text-silver-100 md:mx-0 md:text-xl"
            target="_blank"
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        <div className="container grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6">
          <div className="space-y-6 rounded-xl bg-night-700 p-6 md:p-8">
            <img src="/img/home/lp-rewards.svg" className="w-[42px]" alt="" />
            <div className="space-y-1">
              <h2 className="font-semibold text-cream text-xl md:text-2xl">
                Diverse LP rewards
              </h2>
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
      >
        <div className="relative mt-4 flex flex-col gap-2 overflow-hidden rounded-xl bg-night-700 p-6 md:mt-6 md:p-8">
          <h1 className="relative z-10 font-semibold text-cream text-xl md:text-2xl">
            <span className="text-ruby-600 uppercase">$MAGIC</span> and Fee
            Structure
          </h1>
          <p className="relative z-10 max-w-3xl text-silver-400 md:text-lg">
          ...
          />
          <div className="absolute right-0 bottom-0 hidden h-72 w-96 translate-y-3/4 rounded-full bg-ruby-600 opacity-20 blur-[999px] md:block" />
        </div>
      </motion.div>
      <div className="relative mt-8 overflow-hidden border-t border-t-silver-1000 py-8 md:mt-16 md:py-16">
        <div className="container">
          <div className="relative flex w-full flex-col justify-between gap-6 overflow-hidden rounded-lg border border-night-400 bg-night-700 p-8 sm:flex-row sm:items-center">
            <div className="relative space-y-1">
              <h1 className="font-semibold text-2xl text-cream">
                Start trading today
              </h1>
              <p className="max-w-80 text-lg text-silver-400">
